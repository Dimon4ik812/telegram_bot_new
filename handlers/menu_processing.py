...
async def main_menu(session, level, menu_name):
    ...
    if not banner:
        # Если баннера нет, используем заглушку или пустое сообщение
        image = InputMediaPhoto(media="", caption="Добро пожаловать!")
    else:
